...
public class TinyDB {
    ...
    public ArrayList<recommande_domain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<recommande_domain> playerList =  new ArrayList<recommande_domain>();

        for(String jObjString : objStrings){
            recommande_domain player  = gson.fromJson(jObjString,  recommande_domain.class);
    ...
    public void putListObject(String key, ArrayList<recommande_domain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(recommande_domain player: playerList){
